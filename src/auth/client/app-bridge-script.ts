  ...
  return (function(t) {
    ...
    function(t, e, r) {
      ...
      function P(t, r, n) {
        ...
        return (
          o && (o += "" + (o.length > 0 ? f.SEPARATOR : "") + r.toUpperCase()),
          ...
          this.set = function() {
            ...
            return o.app.hooks
              ? (t = o.app.hooks).run.apply(
                t,
                a([u.LifecycleHook.UpdateAction, i, o], e),
              )
              : i.apply(o, e);
          };
        }
          ...
          (t.prototype.set = function() {
            ...
            (t.prototype.subscribe = function(t, e, r, n) {
              var o,
                ...
                s = r || this.component,
                u = t.toUpperCase(),
                c = "number" == typeof n ? e : e.bind(this);
              o = p.isErrorEventName(t)
                ? P(d.Group.Error, t, i(i({}, s), { type: "" }))
                : P(this.group, t, s);
              var f = this.app.subscribe(o, c, r ? r.id : this.id),
                h = {
                  eventType: u,
                  unsubscribe: f,
                  callback: c,
    ...
    function(t, e, r) {
      ...
      function p(t, e, r) {
        var n = e.id,
          o = r.label,
          u = s.getEventNameSpace(t, a.UPDATE, e),
          c = i(i({}, r), { id: n, label: o });
      ...
      var f = (function(t) {
        function e(e, r) {
          ...
          return (
            (n.disabled = !1), (n.loading = !1), (n.plain = !1), n.set(r, !1), n
          );
        }
    ...
    function(t, e, r) {
      ...
      function p(t, e, r) {
        return (function(t, e, r, n, o) {
          var a = e.id,
            ...
            p = i(i({}, n), { id: a, label: s, payload: o });
      ...
      var f = (function(t) {
        function e(e, r) {
          var n =
            t.call(this, e, c.ComponentType.ButtonGroup, c.Group.ButtonGroup) ||
            this;
          return (
            (n.disabled = !1),
              (n.plain = !1),
    ...
    function(t, e, r) {
      ...
      function p(t, e, r) {
        var n = e.id,
          o = r.label,
          u = r.destination,
          c = i(i({}, r), { id: n, label: o, destination: u });
        return s.actionWrapper({
          group: t,
                  ...
                  var v = new y.default(),
                    _ = {
                        ...
                        return _.getState("features").then(function(e) {
                          return t
                            ? t.reduce(function(t, r) {
                              return (
                                Object.keys(e).includes(r) && (t[r] = e[r]), t
                              );
                            }, {})
                            : e;
                        });
                      ...
                      error: function(t, e) {
                        var r = [];
                        return (
                          i.forEachInEnum(s.Action, function(n) {
                            r.push(P(n, t, e));
                          }),
                            function() {
            ...
            (e.prototype.updateSecondaryFooterButton = function(t, e) {
              if (
                ...
                for (
                  ...
                  var i = o[n];
                  if ((r = c.updateActionFromPayload(i, t))) break;
                }
                r && e();
              }
            }),
        ...
        return (
          o(e, t),
            ...
            (e.prototype.set = function(t, e) {
              var r = this;
              void 0 === e && (e = !0);
              var n = c.getMergedProps(this.options, t),
                o = n.title,
                i = n.footer,
                s = n.message,
                u = n.size;
    ...
    function(t, e, r) {
      ...
      function v(t) {
        return (
          "object" == typeof t && Object.prototype.hasOwnProperty.call(t, "url")
        );
      }
    ...
    function(t, e, r) {
      ...
      e.parsePayloadWithContext = function(t) {
        var e =
          "function" == typeof window.MobileWebView.context
    ...
    function(t, e, r) {
      ...
      e.compatibilityActions = Object.entries(s).reduce(function(t, e) {
        ...
        return Object.keys(s.Group).includes(i)
          ? n(
            n({}, t),
            (((o = {})[i] = n(n({}, a), { ActionType: a.Action })), o),
          )
          : n(n({}, t), (((r = {})[i] = a), r));
      }, {});
    },
    ...
    function(t, e, r) {
      ...
      var u = (function(t) {
        function e(e) {
          return (
            t.call(this, e, s.Group.Fullscreen, s.Group.Fullscreen) || this
          );
        }
    ...
    function(t, e, r) {
      ...
      var h = (function(t) {
        function e(e, r) {
          return (
            t.call(this, e, p.Group.Modal, p.Group.Modal, r ? r.id : void 0) ||
            this
          );
        }
    ...
    function(t, e, r) {
      ...
      var y = (function(t) {
        function e(e, r, n) {
          var o =
            t.call(this, e, p.Group.ResourcePicker, p.Group.ResourcePicker) ||
            this;
          return (
                ...
                t === a.OPEN
                  ...
                  : t === a.UPDATE
                    ...
                    : t === a.CLOSE || t === a.CANCEL
                      ...
                      ((this.selection = e),
                        this.app.dispatch(
                          f({ id: this.id, selection: this.selection }),
                        )),
                  this
              );
            }),
    ...
    function(t, e, r) {
      ...
      var d = { group: h.Group.TitleBar, subgroups: ["Buttons"] },
        l = {
        ...
        function e(e, r) {
          var n =
            t.call(
              this,
              e,
              p.Group.MarketingExternalActivityTopBar,
              p.Group.MarketingExternalActivityTopBar,
            ) || this;
          return n.set(r), n;
        }
          ...
          o(e, t),
            ...
            (e.prototype.updateSecondaryButtons = function(t) {
              if (this.secondary) {
                ...
                if (e) c.updateActionFromPayload(e, t) && this.dispatch(a.UPDATE);
              }
            }),
            (e.prototype.setPrimaryButton = function(t) {
              (this.primaryOptions = this.getChildButton(t, this.primaryOptions)),
      ...
      (e.setClientInterfaceHook = function(t) {
        ...
        (e.compatibilityCreateApp = function(t, r) {
          ...
          return (
            a.isV1Config(t) &&
            o.hooks.set(
              a.LifecycleHook.DispatchAction,
      ...
      (function(t) {
        ...
        (s.encode = o),
          (s.decode = function(e, r) {
            return (
              void 0 === r && (r = "utf8"), t.from(i(e), "base64").toString(r)
            );
          }),
          (s.toBase64 = i),
          (s.fromBase64 = a),
    ...
    function(t, e) {
      ...
      (e.read = function(t, e, r, n, o) {
        var i,
          ...
          d = t[e + f];
        for (
          f += h, i = d & ((1 << -p) - 1), d >>= -p, p += s;
          p > 0;
          i = 256 * i + t[e + f], f += h, p -= 8
        ) ;
        for (
          a = i & ((1 << -p) - 1), i >>= -p, p += n;
          p > 0;
          a = 256 * a + t[e + f], f += h, p -= 8
        ) ;
        if (0 === i) i = 1 - c;
        else {
        ...
        (e.write = function(t, e, r, n, o, i) {
          ...
          for (
            ...
            o >= 8;
            t[r + d] = 255 & s, d += l, s /= 256, o -= 8
          ) ;
          for (
            a = (a << o) | s, c += o;
            c > 0;
            t[r + d] = 255 & a, d += l, a /= 256, c -= 8
          ) ;
          t[r + d - l] |= 128 * y;
        });
    },
